...
/**
 * Vista previa de la importación de administrativos, ANTES de tocar la base.
 *
 ...
 * administrativo (código administrativo en vez de R.U./carrera).
 */
@Getter
@Setter
public class PrevisualizacionAdmCsvDto {
